...
hnmSystem:addOverride("xi.zones.Dragons_Aery.npcs.qm_fafnir.onTrade", function(player, npc, trade)
    local dragonsAeryID = zones[xi.zone.DRAGONS_AERY]
...
hnmSystem:addOverride("xi.zones.Behemoths_Dominion.npcs.qm_behemoth.onTrade", function(player, npc, trade)
    local behemothDomID = zones[xi.zone.BEHEMOTHS_DOMINION]
